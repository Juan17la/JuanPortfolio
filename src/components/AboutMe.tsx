    ...
    <section className="relative w-full px-6 py-24" id="about">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-4">
          ...
          <span className="text-xs uppercase tracking-[0.25em] text-moss font-semibold">
        ...
        <BlurText
          ...
          direction="top"
          threshold={0.1}
          className="font-display text-4xl sm:text-5xl text-text-primary mb-16"
        />
        ...
        <div className="relative hidden md:block" style={{ minHeight: "820px" }}>
          ...
          >
            ...
            {/* Junction dots */}
            <circle cx="55" cy="16" r="0.7" fill="#5a8a6e" opacity={0.5} />
            <circle cx="55" cy="44" r="0.7" fill="#5a8a6e" opacity={0.5} />
            <circle cx="20" cy="66" r="0.7" fill="#5a8a6e" opacity={0.5} />
          </svg>

          {/* Nodes - absolutely positioned */}
          <div className="absolute left-[0%] top-[2%] w-[44%]">
            <FadeContent blur duration={800} delay={100} threshold={0.1}>
          ...
          <div className="absolute left-[38%] top-[85%] w-[50%]">
            <FadeContent blur duration={800} delay={500} threshold={0.1}>
        ...
        <div className="md:hidden relative">
          ...
          <div
            ...
            style={{
              background: "linear-gradient(to bottom, transparent, #5a8a6e 5%, #5a8a6e 95%, transparent)",
              opacity: 0.3,
            }}
          />
          ...
          <div className="flex flex-col gap-8">
            {nodes.map((node, index) => (
              <div key={index} className="relative pl-12">
                {/* Timeline dot */}
                <div
                  className="absolute left-3.5 top-6 w-3 h-3 rounded-full border-2 border-moss/40 bg-background z-10"
                  style={{
                    boxShadow: "0 0 8px rgba(90,138,110,0.3)",
                  }}
                />
                <FadeContent blur duration={700} delay={index * 100} threshold={0.1}>
